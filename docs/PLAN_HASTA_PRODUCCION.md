...
**1.** La alarma que no se detiene. El primer escalón ya existe: `configuracion_escalada_coordinador`
...
**2.** La extensión de turno. La Asistente que está adentro sigue a cargo: el sistema se lo
...
**3.** El consentimiento de la Familia para que el Paciente quede solo —quién lo dio, cuándo y por
...
**4.** El cierre honesto del expediente. Hoy sólo se puede cerrar contando **cómo se cubrió**.
...
**5.** La forma de pago y las horas extra. Hoy no existe la modalidad de pago: la decide el código
...
**6.** La Coordinadora registra lo ya arreglado. Si resolvió el reemplazo por teléfono, lo carga
