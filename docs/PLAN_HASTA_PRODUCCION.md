...
**2. Usted** — En Railway, cargar la variable `PANEL_URL` con la dirección del Panel. Sin ella, el correo con el que una persona elige su primera contraseña no se arma, y quien acaba de recibir el acceso al Panel no puede entrar. El nombre está en `backend/.env.example:40`.
...
**5.** La pantalla del Panel que explique el procedimiento y pida la casilla donde la Prestadora quiere recibir las respuestas, en lugar de la que hoy pide servidor, usuario y contraseña (`panel/src/pages/configuracion/Avisos.jsx`). Las dos fallas posibles del alta se avisan **en el Panel, nunca por correo**, porque lo que falló es el correo: si no se pudo crear la dirección de envío, esa Prestadora manda desde la dirección común; si no se pudo crear el reenvío, manda igual y se pierden las respuestas.

**6.** Contar los correos del día y mostrarlo en el Panel. El plan gratuito de Resend deja 3.000 por mes y **como mucho 100 por día**, y el tope diario es de los que se descubren el peor día.
