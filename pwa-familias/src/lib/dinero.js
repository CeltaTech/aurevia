...
//
// DÓNDE MÁS SE USA
// La Familia ve sus facturas en su propia aplicación, y un importe escrito de dos
// maneras distintas según quién lo mire es motivo de llamado. El original vive acá
// y se copia; la lista está en `scripts/copias_entre_apps.mjs`.
// ---------------------------------------------------------------------------
 ...
 * @param locale  el idioma elegido por quien mira, para el separador de miles.
 */
