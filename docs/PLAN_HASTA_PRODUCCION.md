...
**1.** Sumar el consentimiento del Pagador a la obligación de pagar, con el mismo molde que los
...
**2.** Cambiar por listas los casilleros que hoy se teclean y nombran algo que ya tiene Legajo: la
...
**3.** No hay nada que convertir: **nunca nadie usó la aplicación y no hay datos reales**, así que
...
**6.** Que la pantalla de la Familia tampoco muestre un saldo calculado acá cuando la cobranza la
