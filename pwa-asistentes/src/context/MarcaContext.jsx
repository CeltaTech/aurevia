// La marca que ve el Asistente en esta aplicación.
//
// El Asistente trabaja para su Prestadora, no para Careonys: nunca escuchó ese
// nombre. Por eso el encabezado y los avisos llevan el nombre (o el logo) de la
