...
**1.** El equipo del Paciente. Se arma solo con quienes tienen turnos habituales con él más la
...
**2.** La ausencia guarda **cuándo se supo**. Hoy pedir vacaciones con un mes y no aparecer esta
mañana son lo mismo. Con tiempo, le llega a la Coordinadora como tarea pendiente; de golpe,
dispara la alarma.

**3.** El expediente del turno vacío. Hoy el incidente sólo nace si había alguien asignado que no
...
**4.** La alarma que no se detiene. El primer escalón ya existe: `configuracion_escalada_coordinador`
...
**5.** La extensión de turno. La Asistente que está adentro sigue a cargo: el sistema se lo
...
**6.** El consentimiento de la Familia para que el Paciente quede solo —quién lo dio, cuándo y por
...
**7.** El cierre honesto del expediente. Hoy sólo se puede cerrar contando **cómo se cubrió**.
...
**8.** La forma de pago y las horas extra. Hoy no existe la modalidad de pago: la decide el código
...
**9.** La Coordinadora registra lo ya arreglado. Si resolvió el reemplazo por teléfono, lo carga
...
**78. Usted** — Las escalas legales: la validación, y los dos valores que el código usa y no
