...
**1.** Que cada Familia quede apareada con el cliente que el software de facturación tiene cargado
...
**2.** Escribir la conexión de ida con el software de facturación de la primera Prestadora, cuando
...
**3.** Que la Prestadora pueda cargar en Configuración la conexión con su software de facturación
...
**4.** Que la pantalla de la Familia tampoco muestre un saldo calculado acá cuando la cobranza la
