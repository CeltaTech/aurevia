...
**2.** Hacer la lista de Clientes de la Prestadora: una ficha por persona o por entidad, con
nombre, apellido, datos fiscales, domicilio partido, teléfono y correo, y con su número de cliente
—único y que no se reasigna nunca a nadie más—. Hoy quien contrata no tiene ficha: existe como un
renglón de la solicitud que originó la Familia, y su nombre se teclea de nuevo en cada lugar que lo
necesita. Una entidad —obra social, prepaga, cualquier financiador— entra en esta misma lista.

**3.** Que la contratación anote sus tres roles apuntando a esa lista: quien contrata, para quién
...
**4.** Sumar el consentimiento del Pagador a la obligación de pagar, con el mismo molde que los
...
**5.** Cambiar por listas los casilleros que hoy se teclean y nombran algo que ya tiene ficha: el
...
**6.** No hay nada que convertir: **nunca nadie usó la aplicación y no hay datos reales**, así que
...
**8.** Que la Prestadora pueda cargar en Configuración la conexión con su software de facturación
...
**9.** Que la pantalla de la Familia tampoco muestre un saldo calculado acá cuando la cobranza la
...
**61. Usted** — ¿Dónde corre un módulo y contra qué base? Hoy `Modulos\` está vacía. **Facturación y créditos y cobranzas ya están decididas como software aparte del que Careonys se sirve**, así que esto no decide si salen, sino dónde corren el día que existan. También decide si con eso se cierran sin construir los adaptadores de pasarela.

**62.** Sacar la facturación y la cobranza a un módulo, cuando haya dónde correrlo.
