  ...
  'es-AR': {
    ...
    errores: {
      ...
      motivos: {
        ...
        demasiados_intentos: 'Hubo demasiados intentos seguidos. Conviene esperar un rato y pedir un código nuevo.',
  ...
  en: {
    ...
    errores: {
      ...
      motivos: {
        ...
        demasiados_intentos: 'There were too many attempts in a row. Please wait a while and request a new code.',
  ...
  'pt-BR': {
    ...
    errores: {
      ...
      motivos: {
        ...
        sin_acceso: 'O titular da conta não incluiu isto no que o senhor pode ver. A mudança é ele quem pede à Prestadora.',
        ...
        demasiados_intentos: 'Houve tentativas demais seguidas. Convém esperar um pouco e pedir um código novo.',
    ...
    asistente: {
      ...
      calificar_sin_acceso: 'Avaliar o Assistente não está entre o que o titular da conta concedeu ao senhor. A mudança é ele quem pede à Prestadora.',
    ...
    perfil: {
      ...
      telefono: 'Telefone',
      plan: 'Plano',
      acceso_titulo: 'O que o senhor vê',
      acceso_titular: 'O senhor é o titular da conta: vê tudo o que a Prestadora oferece e é quem decide o que cada pessoa do seu círculo familiar vê.',
      acceso_ve: 'O que o senhor vê',
      acceso_ve_vacio: 'Por enquanto não há nada incluído.',
      acceso_no_ve: 'O que o senhor não vê',
      acceso_no_ve_vacio: 'Não há nada de fora: o senhor vê tudo o que a Prestadora oferece.',
    ...
    medicacion: {
      ...
      sin_acceso_pedir: 'Pedir uma mudança de medicação não está entre o que o titular da conta concedeu ao senhor. A mudança é ele quem pede à Prestadora.',
    ...
    instruccion: {
      ...
      explicacion: 'Isto é o que o senhor pediu à Prestadora sobre o que cada pessoa do seu círculo familiar vê. Já está valendo: o que falta é a sua assinatura.',
      sin_instruccion: 'Não há nenhuma instrução pendente de assinatura.',
      firmar_titulo: 'Assinar',
      firmar_explicacion: 'O senhor já entrou com a sua senha. Para assinar é preciso ainda um código de seis dígitos, que chega por outro caminho.',
