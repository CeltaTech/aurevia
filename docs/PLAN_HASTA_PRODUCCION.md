...
**3.** Construirlo según lo contestado.
...
**5.** El reenvío de las respuestas: una regla de Email Routing por Prestadora, creada en el alta y cortada cuando la Prestadora se va. Cloudflare exige que la Prestadora confirme su dirección de destino con un clic antes de que el reenvío funcione, así que ese estado se muestra.

**6.** La pantalla del Panel que explique el procedimiento y pida la casilla donde la Prestadora quiere recibir las respuestas, en lugar de la que hoy pide servidor, usuario y contraseña (`panel/src/pages/configuracion/Avisos.jsx`). Las dos fallas posibles del alta se avisan **en el Panel, nunca por correo**, porque lo que falló es el correo: si no se pudo crear la dirección de envío, esa Prestadora manda desde la dirección común; si no se pudo crear el reenvío, manda igual y se pierden las respuestas.
