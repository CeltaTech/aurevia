...
**4. Usted** — Autorizar el borrado de lo que quedó vacío en la base. La pantalla que pedía servidor, usuario y contraseña de correo ya no existe, y nada del sistema vuelve a tocar la tabla `configuracion_email_prestadora` ni las dos funciones que guardaban y leían esa contraseña. Quedan ahí ocupando lugar, y una tabla que nadie usa hace creer que alguna pantalla la usa.
...
**79. Usted** — El documento de roles generado desde la base: ¿para quién es, interno de CeltaTech o manual para la Prestadora?
