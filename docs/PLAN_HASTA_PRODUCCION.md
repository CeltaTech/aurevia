...
turno, no se puede registrar que nadie fue, la alarma nunca sube de nivel, y las horas de más no se
pagan. Esta sección lo cierra entero.
...
**1.** El expediente del turno vacío. Hoy el incidente sólo nace si había alguien asignado que no
...
**2.** La alarma que no se detiene. El primer escalón ya existe: `configuracion_escalada_coordinador`
...
**3.** La extensión de turno. La Asistente que está adentro sigue a cargo: el sistema se lo
...
**4.** El consentimiento de la Familia para que el Paciente quede solo —quién lo dio, cuándo y por
...
**5.** El cierre honesto del expediente. Hoy sólo se puede cerrar contando **cómo se cubrió**.
...
**6.** La forma de pago y las horas extra. Hoy no existe la modalidad de pago: la decide el código
...
**7.** La Coordinadora registra lo ya arreglado. Si resolvió el reemplazo por teléfono, lo carga
